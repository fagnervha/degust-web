export const portuguese = {
	...
	"Your account is inactive or Your token has been expired":
		"Your account is inactive or Your token has been expired",
	"prescription is required": "é necessário receita médica",
	"After completing the order, you will receive a":
		"After completing the order, you will receive a",
	"Welcome to 6amMart!": "Bem-vindo ao Degust!",
	...
	"Start exploring the best services around you.":
		"Comece a explorar os melhores serviços ao seu redor.",
	...
	"Enter your order id": "Insira o ID do seu pedido",
	...
	"I’ll Pick It Up MySelf": "Retirar no bolcão",
	"Most Tipped": "Mais recomendado",
	Custom: "Personalizado",
	"Download ON": "Disponível no",
	"No items added in your cart. Please add product to your cart list.":
		"Nenhum item foi adicionado ao seu carrinho. Adicione um produto à sua lista de compras.",
	...
	"Select the type of stores for your order":
		"Select the type of stores for your order",
	"Search location here...": "Pesquise a localização aqui...",
	...
	"Search for items...": "Pesquisar produtos...",
	...
	"Phone is required": "Celular é necessário",
	...
	"Earn money to your wallet by completing the offer & challenged":
		"Ganhe dinheiro em sua carteira ao participar de ofertas e desafios",
	"Convert your loyalty points into wallet money":
		"Converta seus pontos em dinheiro da carteira",
	"Send your wallet money while order": "Envie dinheiro para sua carteira enquanto faz o pedido",
	"Admin also reward their top customers with wallet money":
		"Degust também recompensa seus principais clientes com dinheiro na carteira",
...
"First name":"First name",
	...
	"List view": "Exibir em lista",
	Foods: "Produtos",
	Found: "encontrados",
	view: "view",
	"Grid view": "Exibir em grade",
	"View More": "View More",
	"We found": "We found",
	...
	food: "food",
	This: "O",
	"Available Form": "Disponível a partir das",
	"Fill details": "Preencha os detalhes",
	Confirmation: "Confirmação",
	"is not available right now. You can order it later.":
		"não está disponível no momento. Você pode adquiri-lo mais tarde.",
	...
	"Minimum Order Value": "Pedido mínimo",
	...
	"Minimum 200 points required to convert into currency":
		"São necessários no mínimo 200 pontos para converter em dinheiro",
	"Convert your loyalty point to wallet money.":
		"Converta seus pontos degust em dinheiro na carteira.",
	...
	"Delivery man doesnt assigned": "Entregador não foi designado",
	...
	"Are you sure you want to switch this order to Cash On Delivery?":
		"Tem certeza de que deseja alterar este pedido para pagamento na entrega?",
	...
	"Currently You don’t have any message selected.":
		"Atualmente, você não tem nenhuma mensagem selecionada.",
	"Choose one from your existing messages, or start a new one.":
		"Escolha uma das suas mensagens existentes ou comece uma nova.",
	...
	"I agree that placing the order places me under Terms and Conditions & Privacy Policies":
		"I agree that placing the order places me under Terms and Conditions & Privacy Policies",
	"Delivery Man Tips": "Gorjeta para o motoboy",
	...
	"Add New +": "Add New +",
	"Add new address": "Add new address",
	"Convert to currency now": "Converter para dinheiro",
	...
	"To select from saved addresses, you need to sign in.":
		"Para selecionar entre os endereços salvos, você precisa fazer login.",
	...
	Salary: "Salary",
	"Signup successfully.": "Inscrição bem-sucedida.",
	...
	"Your token has been expired.please sign in again":
		"Your token has been expired.please sign in again",
	"New On": "Novos no",
	"Deliveryman tips": "Gorjeta do Motoboy",
	...
	"I agree that placing the order places me under":
		"Concordo que ao fazer o pedido, estou sujeito aos",
	"Terms and Conditions": "Termos e Condições",
	...
	"Getting Order List...": "Obtendo a lista de pedidos...",
	"Add Cutlery": "Adicionar Talheres",

	"Dont have a cutlery? Restaurant will provide you.":
		"Não tem talheres? O restaurante fornecerá para você.",
	...
	"Search foods and restaurants...": "Pesquisar produtos e lojas...",
	"Wanna Try  Again!": "Wanna Try  Again!",
	"Get your recent food from the restaurant you recently visited":
		"Get your recent food from the restaurant you recently visited",
	"Special Food Offers": "Produtos com promoções especiais",
	...
	"If you want to add fund to your wallet then click add fund button":
		"Se você quiser adicionar saldo à sua carteira, clique no botão adicionar saldo",
	...
	"Easiest way to get services": "A maneira mais fácil de contratar serviços",
	...
	"Note must not be grater than 191 characters":
		"A observação não deve exceder 191 caracteres",
	...
	"Invite and share your code to your friends & family members":
		"Convide e compartilhe seu código com seus amigos e familiares",
	"You made your earning when the order is complete":
		"Seus ganhos são obtidos quando o pedido estiver concluído",
	...
	"using your code and place their first order":
		"usando seu código e fazem o primeiro pedido",
	"No address found": "Endereço não encontrado",
	Road: "Road",
	...
	"See our most popular restaurant and foods":
		"Veja as lojas e os itens mais populares",
	...
	"Rent Type": "Rent Type",
	Vehicle: "Vehicle",
	"Become a Vendor owner": "Torne-se um vendedor",
...
"Your cart has been cleared as the selected zone does not support the previous pickup point.":'Your cart has been cleared as the selected zone does not support the previous pickup point.',
	...
	"discount will be applicable when  order amount exceeds is more than":"de desconto será aplicável quando o valor do pedido exceder",
	"max":"max",
  ...
  "Wishlist": "Favorito",
  "No favourite produto found": "Nenhum produto favorito encontrado",
  "No favourite Restaurantes found": "Nenhuma loja favorita foi encontrada",
  "Order Id": "Pedido ID",
  "Email/Phone": "Email/Celular",
  "Email or phone number is required": "Email ou celular é obrigatório",
  "Minimum 8 characters": "Mínimo de 8 caracteres",
  "Must be a valid email or phone number": "Deve ser um e-mail ou celular válido",
  "No reviews yet": "Nenhuma avaliação",
  "Track Now": "Rastrear",
  "track order": "Rastrear Pedido",
  "Non Veg": "Não Vegan",
  "Already in wishlist": "Já na lista de desejos",
  "Interest updated successfully": "Interesses atualizados com sucesso",
  " Default": " Padrão",
  "Offers": "Ofertas",
  " Fast Delivery": " Entrega rápida",
  " Distance": " Distância",
  "Currently Open": "Aberto agora",
  "discounted": "Com desconto",
  "Proceed To Checkout": "Prosseguir para o checkout",
  "Wallet Balance": "Saldo na carteira",
  "Add To cart": "Adicionar ao carrinho",
  "See less": "Ver menos",
  "Total Bill": "Valor total",
  "This delivery fee includes all the applicable charges on delivery": "Esta taxa de entrega inclui todos os encargos aplicáveis à entrega",
